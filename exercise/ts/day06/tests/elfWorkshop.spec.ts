...
describe("ElfWorkshop Tasks", () => {
  ...
  // why don,'t use fast-check to generate random strings and replace the hardcoded strings  and the 3 first tests ?
  ...
  // readability: if you prefere to use should in the test name, why not use it() instead of test() ?
  ...
  // expliotness: the test name should be more explicit about what behavior is being tested
